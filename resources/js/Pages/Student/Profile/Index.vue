            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 shadow-sm sm:rounded-lg">
                    ...
                    <form @submit.prevent="onSubmit" class="space-y-4">
                        ...
                        <label class="block text-sm font-medium text-gray-700" for="reason">Update Bio</label>
                        <div>
                            <textarea
                                class="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-indigo-500 focus:ring-indigo-500 mt-2"
                                placeholder="Hello, I'm Jinas!" type="text" rows="8" v-model="state.form.reaason" />
                        </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 shadow-sm sm:rounded-lg">
                    ...
                    <form @submit.prevent="onSubmit" class="space-y-4">
                        ...
                        <label class="block text-sm font-medium text-gray-700" for="reason">Update Password</label>
                        <div>
                            <input
                                class="w-full p-3 text-sm border-gray-200 rounded-lg focus:border-indigo-500 focus:ring-indigo-500"
                                id="name" placeholder="Password" type="password" v-model="state.form.password" />
