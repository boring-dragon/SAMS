				...
				<div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
					<div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl lg:grid lg:grid-cols-2 lg:gap-24">
						<div>
							...
							<div class="mt-20">
								<div class="mt-6 sm:max-w-xl space-y-4">
									<h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
										Student
										Attendance Management System
									</h1>
									<p class="mt-6 text-xl text-gray-500">Welcome to SAMS application. This app is going to help you to take attendance for students and Management Enrollments.</p>
									<p>
										<Link class="text-base font-medium text-indigo-500" href="/login">Login&nbsp&rarr;</Link>
									</p>
								</div>
							</div>
						</div>
					...
					<div class="sm:mx-auto sm:max-w-3xl sm:px-6">
						<div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
							<div class="hidden sm:block">
								...
								<svg class="absolute top-8 right-1/2 -mr-3 lg:m-0 lg:left-0" fill="none" height="392" viewBox="0 0 404 392" width="404">
									<defs>
							...
							<div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
								<img alt class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="/images/adminDashboard.png" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
						<div class="relative sm:py-16 lg:py-0">
							<div aria-hidden="true" class="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
								...
								<svg class="absolute top-8 left-1/2 -ml-3 lg:-right-8 lg:left-auto lg:top-12" fill="none" height="392" viewBox="0 0 404 392" width="404">
									<defs>
										<pattern height="20" id="02f20b47-fd69-4224-a62a-4c9de5c763f7" patternUnits="userSpaceOnUse" width="20" x="0" y="0">
											<rect class="text-gray-200" fill="currentColor" height="4" width="4" x="0" y="0" />
										</pattern>
									</defs>
							...
							<div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
								<img alt src="/images/modulePage.png" />
							</div>
						</div>
						...
						<div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
							...
							<div class="pt-12 sm:pt-16 lg:pt-20">
								...
								<div class="mt-6 text-gray-500 space-y-6">
									<p class="text-lg">
										The objective of this system is to provide students with an easy
				...
				<div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
							...
							<div class="mt-20">
								<div class="mt-6 sm:max-w-xl">
									...
									<div class="mt-6 text-xl text-gray-500 space-y-6">
										...
										<li>
											Generate a random attendance code that expires after a certain period of
											time.
										</li>
					...
					<div class="sm:mx-auto sm:max-w-3xl sm:px-6">
						<div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
							...
							<div class="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
								<img alt class="w-full rounded-md shadow-xl ring-1 ring-black ring-opacity-5 lg:h-full lg:w-auto lg:max-w-none" src="/images/studentDashboard.png" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="relative mt-20">
					<div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
						<div class="relative sm:py-16 lg:py-0">
							...
							<div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
								<img alt class="rounded-3xl" src="/images/databaseDesign.png" />
							</div>
						</div>
							...
							<div class="pt-12 sm:pt-16 lg:pt-20">
								...
								<div class="mt-6 text-gray-500 space-y-6">
									<p class="text-lg">
										...
										<br />
										<br />The database we are using to power the application is mysql.
									</p>
								</div>
							</div>
						</div>
					...
					<div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
						<div class="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
							<div>
								...
								<p class="mt-6 max-w-3xl text-lg leading-7 text-gray-500"></p>
								<div class="mt-6">
									<a class="text-base font-medium text-indigo-500" href="#">
										See the frameworks &
										technologies used in the project &nbsp&rarr;
									</a>
								</div>
							</div>
							<div class="mt-12 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
								<div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
									<img alt="Laravel" class="max-h-18" src="https://laravelnews.imgix.net/images/laravel-featured.png" />
								</div>
								<div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
									<img alt="Vuejs" class="max-h-18" src="https://www.vectorlogo.zone/logos/vuejs/vuejs-ar21.png" />
								</div>
								<div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
									<img alt="Laravel" class="max-h-16" src="https://avatars.githubusercontent.com/u/47703742" />
								</div>
								<div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
									<img alt="Tailwindcss" class="max-h-16" src="https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-ar21.png" />
								</div>
								<div class="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
									<img
										alt="Laravel"
