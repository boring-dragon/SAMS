...
<template>
	<div class="flex overflow-hidden bg-gray-100 h-screen">
				...
				<div class="flex flex-col flex-grow pt-5 overflow-y-auto border-r bg-green-700">
					...
					<div class="flex flex-col flex-grow px-4 mt-5">
						<nav class="flex-1 space-y-1 bg-green-700">
							<ul>
								<li>
									<Link :class="route().current('admin.dashboard') ? 'text-neutral-200 bg-green-600' : 'text-neutral-200'" :href="route('admin.dashboard')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-green-900">
								...
								<li>
									<Link :class="route().current('admin.modules.*') ? 'text-neutral-200 bg-green-900' : 'text-neutral-200'" :href="route('admin.modules.index')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-green-900">
								...
								<li>
									<Link :class="route().current('admin.teachers.*') ? 'text-neutral-200 bg-green-900' : 'text-neutral-200'" :href="route('admin.teachers.index')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-green-900">
										<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								...
								<li>
									<Link :class="route().current('admin.students.*') ? 'text-neutral-200 bg-green-900' : 'text-neutral-200 border-neutral-800 hover:border-neutral-800'" :href="route('admin.students.index')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-green-900">
								...
								<li>
									<Link :class="route().current('admin.enrollments.*') ? 'text-neutral-200 bg-green-900' : 'text-neutral-200 border-neutral-800 hover:border-neutral-800'" :href="route('admin.enrollments.index')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-green-900">
										...
										<span class="ml-4">Enrollments</span>
									</Link>
								</li>
								<li>
									<Link class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg text-neutral-200 focus:shadow-outline hover:bg-green-900" href="#">
										<svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							...
							<ul>
								<li>
									<Link :href="route('logout')" as="button" class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform rounded-lg text-neutral-200 focus:shadow-outline" method="post">
					...
					<div class="flex flex-shrink-0 p-4 px-4 bg-green-900">
						<a class="flex-shrink-0 block w-full group" href="#">
							<div class="flex items-center">
								<div>
									<img alt class="inline-block rounded-full h-9 w-9" src="https://robohash.org/jinas" />
								</div>
								<div class="ml-3">
									<p class="text-sm font-medium text-neutral-200">{{ $page.props.auth.user.name }}</p>
								</div>
							</div>
						</a>
					</div>
